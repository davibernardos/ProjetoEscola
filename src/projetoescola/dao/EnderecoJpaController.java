...
import projetoescola.dao.exceptions.NonexistentEntityException;
...
public class EnderecoJpaController implements Serializable{
    ...
    public static EntityManagerFactory getEM() {
        EntityManagerFactory factory = Persistence.createEntityManagerFactory("ProjetoEscolaPU");
        return factory;
    }
